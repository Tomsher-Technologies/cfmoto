    ...
    <div class="contact-us-enterInformation-component">
        <div data-component="contact-us-enterInformation-component" class="contact_us_enterInformation_component">
            <div data-v-7b5f97a0="" id="contactUs">
                ...
                <div class="row w-100">
                    <div class="col-md-7">
                        <div data-v-43473ba4="" data-v-7b5f97a0="" class="contactUs_banner m-0"><img data-v-43473ba4=""
                                src="{{ asset('assets/images/5th.jpg') }}" alt="" class="contactUs_banner_img isPc">
                            <img data-v-43473ba4="" src="{{ asset('assets/images/contact_us_mobile.png') }}" alt=""
                                class="contactUs_banner_mobile_img isMobile"></div>
    ...
    <section class="multi-location">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane"
                    type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Dubai</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane"
                    type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">Saudi Arabia
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact-tab-pane"
                    type="button" role="tab" aria-controls="contact-tab-pane" aria-selected="false">Kuwait</button>
            </li>
                    ...
                    <div class="col-md-3">
                        <div class="location-info">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="mailto:info@cfmoto-uae.com">
      ...
      c0,0.803-0.015,1.597-0.116,2.304l-1.386,9.472L329.012,265.409l156.36-136.418V388.572z" />
                    ...
                    <div class="col-md-9"><iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d462560.6827956668!2d54.897843286837066!3d25.076280454847193!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f43496ad9c645%3A0xbde66e5084295162!2sDubai!5e0!3m2!1sen!2sae!4v1706852906998!5m2!1sen!2sae"
